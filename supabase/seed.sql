...
-- =============================================
INSERT INTO public.listings (category, title, description, price, currency, location, amenities, contact, contact_type, images) VALUES
  -- Housing - An Thuong Area
  ('housing', 'An Thuong Studio with Pool', 'Bright studio for 3-6 months, quiet street, 5 min to beach. Perfect for digital nomads. Building has gym and rooftop bar.', 420, 'USD', 'An Thuong', ARRAY['pool', 'wifi', 'kitchen', 'gym', 'rooftop'], '@danang_host', 'telegram', ARRAY['https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800']),
  ('housing', 'Modern An Thuong Flat', 'Fully furnished 1BR with fast fiber internet. Walking distance to all cafes and restaurants. Monthly cleaning included.', 480, 'USD', 'An Thuong', ARRAY['wifi', 'kitchen', 'cleaning', 'balcony'], '@anthung_apts', 'telegram', ARRAY['https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800']),
  ('housing', 'Cozy Studio Near Beach', 'Small but cozy studio, 2 min walk to My Khe beach. Great for solo travelers. AC, hot water, fast wifi.', 320, 'USD', 'An Thuong', ARRAY['wifi', 'ac', 'hot_water'], '@beach_living', 'telegram', ARRAY['https://images.unsplash.com/photo-1554995207-c18c203602cb?w=800']),

  -- Housing - My Khe Area
  ('housing', 'My Khe 1BR Near Beach', 'One-bedroom apartment with balcony and fast WiFi. Ocean view from bedroom. Building has 24/7 security.', 520, 'USD', 'My Khe', ARRAY['wifi', 'balcony', 'ocean_view', 'security'], '@mykhe_living', 'telegram', ARRAY['https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800']),
  ('housing', 'Luxury My Khe Apartment', 'High-end 2BR apartment with stunning beach view. Premium building with pool, gym, and concierge. Perfect for couples or small families.', 1200, 'USD', 'My Khe', ARRAY['pool', 'gym', 'concierge', 'ocean_view', 'parking'], '@luxury_dn', 'whatsapp', ARRAY['https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800']),
  ('housing', 'My Khe Studio - Budget Friendly', 'Clean and simple studio perfect for budget-conscious nomads. 5 min to beach, quiet neighborhood.', 280, 'USD', 'My Khe', ARRAY['wifi', 'ac', 'kitchen'], '@budget_dn', 'telegram', ARRAY['https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=800']),

  -- Housing - Ngu Hanh Son
  ('housing', 'Ngu Hanh Son Villa 2BR', 'Small villa with garden, ideal for long stays. Quiet area near Marble Mountains. Has motorbike parking.', 680, 'USD', 'Ngu Hanh Son', ARRAY['garden', 'parking', 'kitchen', 'quiet'], '@villa_owner', 'whatsapp', ARRAY['https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800']),
  ('housing', 'Garden House with Pool', 'Private house with tropical garden and small pool. Perfect for remote workers who need space and quiet.', 850, 'USD', 'Ngu Hanh Son', ARRAY['pool', 'garden', 'parking', 'office_space'], '@garden_house', 'telegram', ARRAY['https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=800']),

  -- Housing - Son Tra
  ('housing', 'Son Tra Mountain View', 'Unique apartment with view of Son Tra peninsula. Close to nature, 15 min to beach by bike.', 450, 'USD', 'Son Tra', ARRAY['mountain_view', 'parking', 'wifi', 'quiet'], '@sontra_apt', 'telegram', ARRAY['https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800']),
  ('housing', 'Beachfront Son Tra', 'Right on the beach! Wake up to waves. Small but perfect location. Ideal for surfers.', 550, 'USD', 'Son Tra', ARRAY['beachfront', 'wifi', 'surfboard_storage'], '@beachfront_dn', 'telegram', ARRAY['https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=800']),

  -- Housing - Hai Chau (City Center)
  ('housing', 'City Center Serviced Apartment', 'Modern serviced apartment in heart of Danang. Daily cleaning, 24/7 reception. Close to Dragon Bridge.', 650, 'USD', 'Hai Chau', ARRAY['serviced', 'cleaning', 'reception', 'central'], '@city_apts', 'telegram', ARRAY['https://images.unsplash.com/photo-1515263487990-61b07816b324?w=800']),
  ('housing', 'Han River View Flat', 'Beautiful flat overlooking Han River. See Dragon Bridge fire show from your balcony!', 580, 'USD', 'Hai Chau', ARRAY['river_view', 'balcony', 'central', 'wifi'], '@hanriver_view', 'telegram', ARRAY['https://images.unsplash.com/photo-1560185007-c5ca9d2c014d?w=800']),

  -- Bikes
  ('bike', 'Honda Air Blade 125cc', 'Automatic bike, monthly rental, includes helmet. Well maintained, new tires. Delivery available.', 90, 'USD', 'An Thuong', ARRAY['helmet', 'delivery', 'insurance'], '@bikehub_dn', 'telegram', ARRAY['https://images.unsplash.com/photo-1558981806-ec527fa84c39?w=800']),
  ('bike', 'Yamaha Janus 125cc', 'Comfortable scooter, weekly or monthly rental. Great for city driving. Pink/white color.', 70, 'USD', 'Son Tra', ARRAY['helmet', 'phone_holder'], '@janus_rent', 'telegram', ARRAY['https://images.unsplash.com/photo-1558980664-769d59546b3d?w=800']),
  ('bike', 'Honda SH 150i Premium', 'Premium scooter for those who want comfort. ABS, smart key, lots of storage. Monthly only.', 150, 'USD', 'My Khe', ARRAY['abs', 'smart_key', 'storage', 'helmet'], '@premium_bikes', 'telegram', ARRAY['https://images.unsplash.com/photo-1609630875171-b1321377ee65?w=800']),
  ('bike', 'Yamaha NVX 155cc', 'Sporty automatic bike. Fast and fun. Good for longer trips to Hoi An or Hue.', 100, 'USD', 'Hai Chau', ARRAY['helmet', 'insurance', 'roadside_assist'], '@nvx_rental', 'telegram', ARRAY['https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800']),
  ('bike', 'Honda Vision 110cc', 'Economical and reliable. Perfect for daily commute. Cheapest rental in town.', 55, 'USD', 'An Thuong', ARRAY['helmet', 'delivery'], '@budget_bikes', 'telegram', ARRAY['https://images.unsplash.com/photo-1571008887538-b36bb32f4571?w=800']),
  ('bike', 'Honda Winner X 150cc', 'Manual transmission sport bike. For experienced riders who want power.', 120, 'USD', 'Son Tra', ARRAY['helmet', 'gloves', 'insurance'], '@sport_bikes_dn', 'telegram', ARRAY['https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=800']);
